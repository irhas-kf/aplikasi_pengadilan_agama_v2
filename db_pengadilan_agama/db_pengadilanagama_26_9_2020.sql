...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Sep 2020 pada 06.57
...
--
-- Dumping data untuk tabel `tb_realisasi_anggaran`
--
...
(2, 1000000, 1083400, -83400, '2020-09-13'),
(3, 1000000, 0, 0, '2021-09-16'),
(4, 1000000, 0, 0, '2022-09-16');
...
--
ALTER TABLE `tb_perencanaan_anggaran`
  MODIFY `id_perencanaan_anggaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT untuk tabel `tb_realisasi_anggaran`
--
ALTER TABLE `tb_realisasi_anggaran`
  MODIFY `id_realisasi_anggaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
