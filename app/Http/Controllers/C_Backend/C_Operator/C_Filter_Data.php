...
class C_Filter_Data extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('V_Backend.V_operator.V_Filter_Data',[
            'tahun_sekarang'=>$tahun_sekarang,
            'filter_data_tahun_operator_session'=>$filter_data_tahun_operator_session
        ]);
    ...
    public function update_session_tahun(Request $request, $tahun_session){
        // echo $tahun_session;
        $request->session()->put('filter_data_tahun_operator', $tahun_session);
        return back();
    }
