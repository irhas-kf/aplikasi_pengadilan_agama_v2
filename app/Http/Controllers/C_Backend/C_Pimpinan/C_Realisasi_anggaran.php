...
class C_Realisasi_anggaran extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    // dd($ambil_bulan_realisasi_anggaran_form_input);
    ...
    return view('V_Backend.V_Pimpinan.V_Realisasi_anggaran', compact(
      'nilai_bulan',
      'nominal_master',
      'ambil_bulan_realisasi_anggaran_form_input',
      'ambil_bulan_realisasi_anggaran_form_edit',
  ...
  public function aksi_save_realisasi_anggaran(Request $request)
  {
    ...
    if ($nilai_perencanaan_anggaran < $realisasi) {
      ...
      $tanggal = $filter_data_tahun_pimpinan_session . "-" . $m_saatini . "-" . $d_saatini;
  ...
  public function show_autocomplate(Request $request, $id)
  {
    ...
    $tb_perencanaan = DB::table('tb_perencanaan_anggaran')
      ...
      ->whereYear('tb_perencanaan_anggaran.tanggal_perencanaan_anggaran', '=', $filter_data_tahun_pimpinan_session)
      ->get();
