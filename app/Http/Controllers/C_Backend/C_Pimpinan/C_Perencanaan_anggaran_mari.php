...
class C_Perencanaan_anggaran_mari extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    $th_saatini = date('Y');
    $tbl_bulan = DB::table('tb_perencanaan_anggaran_mari')
    ...
    $tb_perencanaan_anggaran_mari_ambil_tanggal = DB::table('tb_perencanaan_anggaran_mari')
      ->select(DB::raw('SUBSTRING(tb_perencanaan_anggaran_mari.tanggal_perencanaan_anggaran, 6,2) AS bulan_perencanaan_anggaran'))
      ->whereYear('tanggal_perencanaan_anggaran', '=', $filter_data_tahun_pimpinan_session)
      ->get();

    $myarray2 = [];

    foreach ($tb_perencanaan_anggaran_mari_ambil_tanggal as $data) {
    ...
    return view('V_Backend.V_Pimpinan.V_Perencanaan_anggaran_mari', compact(
      'nilai_bulan',
      'nominal_master',
      'ambil_bulan_perencanaan_anggaran_form_input',
      'ambil_bulan_perencanaan_anggaran_form_edit',
  ...
  public function aksi_save_perencanaan_anggaran(Request $request)
  {
    ...
    $tanggal = $filter_data_tahun_pimpinan_session . "-" . $m_saatini . "-" . "01";

    DB::table('tb_perencanaan_anggaran_mari')->insert([
  ...
  public function show_autocomplate($id)
  {
  ...
  public function aksi_update_perencanaan_anggaran(Request $request)
  {
    ...
    DB::table('tb_perencanaan_anggaran_mari')
      ->where('id_perencanaan_anggaran', $id_perencanaan)
      ->update([
        'nilai_perencanaan_anggaran' => $nilai_perencanaan_anggaran,
      ]);

    $tb_perencanaan_anggaran_mari = DB::table('tb_perencanaan_anggaran_mari')
      ->select(DB::raw('SUM(tb_perencanaan_anggaran_mari.nilai_perencanaan_anggaran) AS total_nominal'))
      ->whereYear('tanggal_perencanaan_anggaran', '=', $filter_data_tahun_pimpinan_session)
      ->get();

    foreach ($tb_perencanaan_anggaran_mari as $tbperencanaan) {
