...
class C_Realisasi_anggaran extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    $th_saatini = date('Y');
    $tbl_bulan = DB::table('tb_realisasi_anggaran')
    ...
    if ($tb_saldo->isEmpty()) {
      ...
      foreach ($tb_saldo as $tbsaldo_mari) {
    ...
    $tb_realisasi_anggaran_ambil_tanggal = DB::table('tb_realisasi_anggaran')
      ->select(DB::raw('SUBSTRING(tb_realisasi_anggaran.tanggal_realisasi_anggaran, 6,2) AS bulan_realisasi_anggaran'))
      ->whereYear('tb_realisasi_anggaran.tanggal_realisasi_anggaran', '=', $filter_data_tahun_admin_session)
      ->get();

    $myarray2 = [];

    foreach ($tb_realisasi_anggaran_ambil_tanggal as $data) {
    ...
    return view('V_Backend.V_Admin.V_Realisasi_anggaran', compact(
      'nilai_bulan',
      'nominal_master',
      'ambil_bulan_realisasi_anggaran_form_input',
      'ambil_bulan_realisasi_anggaran_form_edit',
  ...
  public function aksi_save_realisasi_anggaran(Request $request)
  {
    ...
    if ($nilai_perencanaan_anggaran < $realisasi) {
      ...
      DB::table('tb_realisasi_anggaran')->insert([
  ...
  public function aksi_update_realisasi_anggaran(Request $request)
  {
    ...
    if ($anggaran < $realisasi) {
      ...
      DB::table('tb_realisasi_anggaran')
  ...
  {
    $filter_data_tahun_admin_session = $request->session()->get('filter_data_tahun_admin');
    // dd($filter_data_tahun_admin_session);
    $tb_perencanaan = DB::table('tb_perencanaan_anggaran')
      ...
      ->whereYear('tb_perencanaan_anggaran.tanggal_perencanaan_anggaran', '=', $filter_data_tahun_admin_session)
      ->get();
  ...
  {
    $tb = DB::table('tb_perencanaan_anggaran')
      ->select(DB::raw('tb_perencanaan_anggaran.*'))
      ->whereMonth('tb_perencanaan_anggaran.tanggal_perencanaan_anggaran', '=', $id)
      ->get();
  ...
  {
    $tb = DB::table('tb_realisasi_anggaran')
      ->select(DB::raw('tb_realisasi_anggaran.*'))
      ->whereMonth('tb_realisasi_anggaran.tanggal_realisasi_anggaran', '=', $id)
      ->get();
