...
class C_Dashboard extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    // $filter_data_tahun_admin_session = date('Y');
    //laporan pp39
    ...
    WHERE SUBSTRING(`tb_laporan`.`bulan_tahun_laporan`, 4,4) = '$filter_data_tahun_admin_session'
    ...
    return view('V_Backend.V_Admin.V_Dashboard', [
  ...
  public function cetak_pdf(Request $request)
  {
    ...
    $pdf = PDF::loadview('V_Backend.V_Admin.V_cetakpdf', ['peserta' => $peserta]);
    $pdf->save(storage_path() . '_filename.pdf');
    return $pdf->download('cetak_admin_pdf');
  }
