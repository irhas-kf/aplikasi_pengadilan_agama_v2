                ...
                <div class="tab-pane fade show active" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                  <div class="d-flex">
                    ...
                    <p class="ml-auto d-flex flex-column text-right">
                      ...
                      <span class="text-muted">tahun {{ Session::get('filter_data_tahun_pimpinan')}}</span>
                    </p>
                  </div>
                  <!-- /.d-flex -->
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p><strong>Tabel Kepatuhan Laporan tahun {{ Session::get('filter_data_tahun_pimpinan')}}</strong></p>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_perkara_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-pdf"></i></a></td>
                        <?php
                        } else if (substr($value_perkara_pdf, -4) == 'xlsx') {
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_perkara_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-excel" style="color:green"></i></a></td>
                        <?php
                        }
                        ?>
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_pp39_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-pdf"></i></a></td>
                        <?php
                        } else if (substr($value_pp39_pdf, -4) == 'xlsx') {
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_pp39_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-excel" style="color:green"></i></a></td>
                        <?php
                        }
                        ?>
                      <?php
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_lpj01_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-pdf"></i></a></td>
                        <?php
                        } else if (substr($value_lpj01_pdf, -4) == 'xlsx') {
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_lpj01_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-excel" style="color:green"></i></a></td>
                        <?php
                        }
                        ?>
                      <?php
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_lpj04_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-pdf"></i></a></td>
                        <?php
                        } else if (substr($value_lpj04_pdf, -4) == 'xlsx') {
                        ?>
                          <td style="text-align:center"><a href="{{url('backend_pimpinan_download_file',$value_lpj04_pdf)}}" class="btn btn-outline-primary btn-flat"><i class="fas fa-file-excel" style="color:green"></i></a></td>
                        <?php
                        }
                        ?>
                      <?php
