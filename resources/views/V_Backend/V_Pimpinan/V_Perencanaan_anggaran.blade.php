...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Perencanaan Anggaran DIPA BADILAG</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/backend_pimpinan_perencanaan_anggaran') }}">Home</a></li>
            <li class="breadcrumb-item active">Perencanaan Anggaran</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Table Perencanaan Tahun {{ Session::get('filter_data_tahun_pimpinan')}}</h3>
...
<div class="modal fade" id="modal-sm1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/pimpinan_aksi_save_perencanaan_anggaran/tambah_aksi') }}" enctype="multipart/form-data">
        @csrf
...
<div class="modal fade" id="modal-sm2">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/pimpinan_aksi_update_saldo/update_aksi') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
           <div class="form-group">
...
<script>
              ...
              function editperencanaan(){
                ...
                var url = "{{url('pimpinan_show_autocomplate')}}";
