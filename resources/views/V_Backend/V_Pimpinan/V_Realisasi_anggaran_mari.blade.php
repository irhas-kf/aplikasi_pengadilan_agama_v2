      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/backend_pimpinan_realisasi_anggaran_mari') }}">Home</a></li>
...
<div class="modal fade" id="modal-sm1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/pimpinan_aksi_save_realisasi_anggaran_mari/tambah_aksi') }}" enctype="multipart/form-data">
        @csrf
...
<div class="modal fade" id="modal-sm2">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/pimpinan_aksi_save_realisasi_anggaran_mari/update_aksi') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
          <div class="form-group">
            <label>Pilih Bulan</label>
...
<script>
  function inputrealisai() {
    ...
    var url = "{{url('pimpinan_show_autocomplate_mari/realisasi')}}";
...
<script>
  function editrealisai(val) {
    ...
    var url = "{{url('/pimpinan_show_autocomplate_edit_mari/realisasi')}}";
    ...
    var url = "{{url('/pimpinan_show_autocomplate_edit_mari/realisasi1')}}";
    $.get(url + '/' + val, function(data) {
