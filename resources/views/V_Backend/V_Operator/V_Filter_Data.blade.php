      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/backend_operator_cetak_laporan') }}">Home</a></li>
        ...
        <div class="col-md-12">
          <div class="card card-secondary">
            <div class="card-header">
              <h3 class="card-title">Pilih Tahun Filter Data (Sekarang anda memilih tahun <?php echo $filter_data_tahun_operator_session; ?> )</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                ...
                ?>
                  <div class="btn-group mr-3 mb-3" role="group" aria-label="Third group">
                    <?php
                    if ($i == $filter_data_tahun_operator_session) {
                    ?>
                    ...
                    ?>
                      ...
                      <a href='{{url("backend_operator_filter_data_update_session_tahun/$i")}}' class="btn btn-success" style="padding:20px;">
                        <i class="fa fa-calendar-alt fa-8x" aria-hidden="true"></i>
                        <br>
                        <span style="font-size:20px;"><?php echo $i; ?></span>
                      </a>
