          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">DIPA BALDILAG</a>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content" id="custom-content-below-tabContent">
                <div class="tab-pane fade show active" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                  ...
                  <div class="position-relative mb-4">
                    <canvas id="grafik_anggran_mari" height="200"></canvas>
                  ...
                  <p><strong>Perencanaan Anggaran DIPA BALDILAG</strong></p>
                  <table class="table">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <?php echo "Rp " . number_format((float) $value, 2, ',', '.'); ?>
                          <hr>
                          <p align="center"><span class="badge bg-success">(<?php $rumus2 = (int) $value / $nominal_master * 100;
                                                                            echo round($rumus2, 2);  ?>%)</span></p>
                  ...
                  <p><strong>Realisasi Anggaran DIPA BALDILAG</strong></p>
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="text-align:center">Januari</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <?php echo "Rp " . number_format((float) $value2, 2, ',', '.'); ?>
                          <hr>
                          <p align="center"><span class="badge bg-success">(<?php $rumus2 = (int) $value2 / $nominal_master * 100;
                                                                            echo round($rumus2, 2);  ?>%)</span></p>
                ...
                <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                  ...
                  <div class="position-relative mb-4">
                    <!-- <canvas id="grafik_anggran_mari" height="200"></canvas> -->
                    <!-- <canvas id="grafik_anggran_mari" height="250" style="display: block;height: 200px;width: 733px;" width="916" class="chartjs-render-monitor"></canvas> -->
                  </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <?php echo "Rp " . number_format((float) $value, 2, ',', '.'); ?>
                          <hr>
                          <p align="center"><span class="badge bg-success">(<?php $rumus2_mari = (int) $value / $nominal_master_mari * 100;
                                                                            echo round($rumus2_mari, 2);  ?>%)</span></p>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <?php echo "Rp " . number_format((float) $value2, 2, ',', '.'); ?>
                          <hr>
                          <p align="center"><span class="badge bg-success">(<?php $rumus2_mari = (int) $value2 / $nominal_master_mari * 100;
                                                                            echo round($rumus2_mari, 2);  ?>%)</span></p>
