      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Realisasi Anggaran DIPA BADILAG</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<div class="modal fade" id="modal-sm1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_save_realisasi_anggaran/tambah_aksi') }}" enctype="multipart/form-data">
        @csrf
...
<div class="modal fade" id="modal-sm2">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_save_realisasi_anggaran/update_aksi') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
          <div class="form-group">
            <label>Pilih Bulan</label>
...
<script>
  function inputrealisai() {
    ...
    var url = "{{url('show_autocomplate/realisasi')}}";
...
<script>
  function editrealisai(val) {
    ...
    var url = "{{url('/show_autocomplate_edit/realisasi')}}";
    ...
    var url = "{{url('/show_autocomplate_edit/realisasi1')}}";
    $.get(url + '/' + val, function(data) {
