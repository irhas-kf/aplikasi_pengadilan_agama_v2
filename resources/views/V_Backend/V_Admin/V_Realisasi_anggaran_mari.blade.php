...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Realisasi Anggaran DIPA MARI</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/backend_admin_realisasi_anggaran_mari') }}">Home</a></li>
            <li class="breadcrumb-item">Realisasi Anggaran</li>
            <li class="breadcrumb-item active">Realisasi Anggaran DIPA MARI</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Table Realisasi Tahun {{ Session::get('filter_data_tahun_admin')}}</h3>
...
<div class="modal fade" id="modal-sm1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_save_realisasi_anggaran_mari/tambah_aksi') }}" enctype="multipart/form-data">
        @csrf
...
<div class="modal fade" id="modal-sm2">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_save_realisasi_anggaran_mari/update_aksi') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
          <div class="form-group">
            <label>Pilih Bulan</label>
...
<script>
  function inputrealisai() {
    ...
    var url = "{{url('show_autocomplate_mari/realisasi')}}";
...
<script>
  function editrealisai(val) {
    ...
    var url = "{{url('/show_autocomplate_edit_mari/realisasi')}}";
    ...
    var url = "{{url('/show_autocomplate_edit_mari/realisasi1')}}";
    $.get(url + '/' + val, function(data) {
