      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Perencanaan Anggaran DIPA BADILAG</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<div class="modal fade" id="modal-sm1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_save_perencanaan_anggaran/tambah_aksi') }}" enctype="multipart/form-data">
        @csrf
...
<div class="modal fade" id="modal-sm2">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_update_perencanaan_anggaran/update_aksi') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
           <div class="form-group">
