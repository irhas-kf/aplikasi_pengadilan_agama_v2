...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Saldo DIPA MARI</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/backend_admin_saldo_perencanaan_mari') }}">Home</a></li>
            <li class="breadcrumb-item">Saldo</li>
            <li class="breadcrumb-item active">Saldo DIPA MARI</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center" style="width: 20%">
                      ...
                      <a href="{{url('backend_admin_saldo_perencanaan_delete_mari',$data->id_saldo)}}" class="btn btn-outline-danger btn-flat">Hapus</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
...
<div class="modal fade" id="modal-sm1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_save_saldo_mari/tambah_aksi') }}" enctype="multipart/form-data" enctype="multipart/form-data">
        {{ csrf_field() }}
...
<div id="modal_laporan_edit" class="modal fade">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('/aksi_update_saldo_mari/update_aksi') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
